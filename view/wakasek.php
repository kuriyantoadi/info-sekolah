...
<div class="container">
    <div class="row">
        <div class="col-md-12 mb-4">
            <center>
                <h3 style="margin-top:  25px;"><b>Daftar Wakil Kepala Sekolah</b></h3>
            </center>
        </div>
    ...
    <table class="table table-bordered table-hover" id="domainsTable">
        ...
        include '../koneksi.php';
        $no = 1;
        $data = mysqli_query($koneksi, "SELECT * from tb_guru WHERE bag_pegawai='wakil kepala sekolah' ORDER BY s_pegawai, nama_guru ASC");
